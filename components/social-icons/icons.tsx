...
export function Tiktok(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...svgProps}>
      <title>TikTok</title>
      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.89-.6-4.13-1.38-.13-.08-.2-.23-.3-.35v8.34c0 1.94-.54 3.94-1.92 5.31-1.37 1.37-3.35 1.9-5.27 1.9-1.91 0-3.89-.53-5.26-1.9-1.37-1.38-1.92-3.37-1.92-5.31 0-1.94.55-3.94 1.92-5.31 1.38-1.37 3.35-1.9 5.27-1.9.32 0 .63.02.95.06v4.07c-1.14-.34-2.43-.1-3.32.68-.88.79-1.14 2.12-.66 3.18.48 1.06 1.7 1.67 2.85 1.48 1.14-.19 1.98-1.22 1.98-2.38V.02z" />
    </svg>
  )
}
